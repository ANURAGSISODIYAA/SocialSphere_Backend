...
public class AppConfig {
	...
	private CorsConfigurationSource corsConfigurationSource() {
		...
		cfg.setAllowedMethods(Arrays.asList("GET", "POST", "PUT", "DELETE")); // Specify allowed HTTP methods
		...
		source.registerCorsConfiguration("/**", cfg); // Apply CORS configuration to all paths
